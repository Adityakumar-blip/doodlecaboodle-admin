...
const FeaturedCollectionsPage = () => {
  ...
  useEffect(() => {
    const fetchCollections = async () => {
      try {
        const featuredCollections = await getCollectionsByType("featured");
    ...
    <div className="container p-6 mx-auto">
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Manage your featured collections
          </p>
        </div>
      ...
      {loading ? (
        ...
        <div className="text-center p-12 border rounded-lg bg-muted/20">
          ...
          <h3 className="mt-4 text-xl font-medium">No featured collections found</h3>
          <p className="text-muted-foreground mt-2">
            Start adding featured collections to showcase your best work
          </p>
