...
const SeasonalCollectionsPage = () => {
  ...
  useEffect(() => {
    const fetchCollections = async () => {
      try {
        const seasonalCollections = await getCollectionsByType("seasonal");
        setCollections(seasonalCollections);
      } catch (error) {
    ...
    <div className="container p-6 mx-auto">
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Manage your seasonal artwork collections
          </p>
        </div>
      ...
      {loading ? (
        ...
        <div className="text-center p-12 border rounded-lg bg-muted/20">
          ...
          <h3 className="mt-4 text-xl font-medium">No seasonal collections found</h3>
          <p className="text-muted-foreground mt-2">
            Create collections for different seasons to organize your work
          </p>
